...
import { PostItemProps } from '../../lib/utils/interface/interface';

export default function Post({ ...props }: PostItemProps['item']) {
    const navigate = useNavigate();
    const dispatch = useDispatch();
    const writer = props.author;
    const item = props;
    console.log(writer);
    console.log(item);

    const [heartState, setHeartState] = useState<boolean>(item?.hearted!);
    const [heartCount, setHeartCount] = useState<number>(item?.heartCount!);
